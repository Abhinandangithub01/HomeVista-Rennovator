...
const ImageUploader: React.FC<ImageUploaderProps> = ({ onImageUpload, imagePreviewUrl }) => {
  ...
  return (
    <div className="group bg-gray-800/50 p-6 rounded-xl border-2 border-dashed border-gray-600 transition-all duration-300 hover:border-indigo-500">
      <label 
        ...
        onDrop={onDrop}
      >
        <div className={`flex flex-col items-center justify-center p-4 rounded-lg transition-colors ${isDragging ? 'bg-indigo-900/30' : ''}`}>
          {imagePreviewUrl ? (
